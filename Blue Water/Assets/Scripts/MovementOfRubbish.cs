...
public class MovementOfRubbish : MonoBehaviour
{
    ...
    public void OnMouseEnter()
    {
        ...
        {
            for (int i = 0; i < GameObject.FindGameObjectWithTag("Manager").GetComponent<GameManager1>().objectsOfGarbage.Count; i++)
            {
                GameObject.FindGameObjectWithTag("Manager").GetComponent<GameManager1>().objectsOfGarbage[i].GetComponent<MovementOfRubbish>().movable = false;
        ...
        for (int i = 0; i < GameObject.FindGameObjectWithTag("Manager").GetComponent<GameManager1>().objectsOfGarbage.Count; i++)
        {
            movableOfOther = GameObject.FindGameObjectWithTag("Manager").GetComponent<GameManager1>().objectsOfGarbage[i].GetComponent<MovementOfRubbish>().movable;
            if (movableOfOther)
